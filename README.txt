...
Выбор символов
    ...
    Для готовых наборов __**_ (** это имя (из любого кол-вы символов))
    ...
    Дополнительные наборы
        ...
        Параметры
            ...
            symbols_upper - набор символов в верхнем регистре
                (если не указан (и case_sensitive=True) используется метод upper,
